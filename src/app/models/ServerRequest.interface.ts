...
export interface ServerRequest{
    body : UserLogin | UserRegister | Brand | Modello | Categoria | ProdottiFull | ProdottiFull[] | Indirizzo | Indirizzo[] | Codice_Sconto | Codice_Sconto[] | Reso[] | {product : ProdottiFull, quantity : number, tagliaScelta : string}[] | undefined;
}