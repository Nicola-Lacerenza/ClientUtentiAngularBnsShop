...
export class IndirizzoService {
  ...
  public getindirizzi(): Observable<ServerResponse>{
    return this.httprequest.getRequest(environment.serverUrl + "/indirizzoServlet");
  }

  public insertindirizzo(body:ServerRequest):Observable<ServerResponse>{
    return this.httprequest.postRequest(environment.serverUrl + "/indirizzoServlet",body)
  }
